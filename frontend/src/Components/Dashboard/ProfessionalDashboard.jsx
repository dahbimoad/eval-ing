...
import { BookOpen, Send, Users, TrendingUp, CheckCircle, Clock, AlertCircle, Briefcase } from "lucide-react";
import SidebarProfessional from "./SidebarProfessional";

export default function ProfessionalDashboard() {
  const { questionnaires, loading } = useProfessionalQuestionnaires();
  ...
  useEffect(() => {
    ...
    if (searchParams.get('submitted') === 'true') {
      ...
      toast.info("Bienvenue dans votre espace professionnel 👋", {
        position: "top-right",
        autoClose: 3000,
      });
    }
              ...
              <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0">
                <div>
                  ...
                  <p className="text-slate-600 mt-1 lg:mt-2 text-sm lg:text-base">
                    Consultez et remplissez les questionnaires qui vous sont assignés
                  </p>
                </div>
                <div className="flex items-center space-x-3 lg:space-x-4">
                  <div className="bg-green-100 text-green-600 p-2 lg:p-3 rounded-xl">
              ...
              <div className="max-w-7xl mx-auto">
                <div className="flex flex-col sm:flex-row gap-4">
                  <div className="flex-1">
                    <div className="relative">
                      <input
                        ...
                        className="w-full pl-10 pr-4 py-2 lg:py-3 border-2 border-slate-200 rounded-xl focus:border-green-500 focus:ring-4 focus:ring-green-100 focus:outline-none transition-all text-sm lg:text-base"
                      />
                  ...
                  <select
                    ...
                    className="px-4 py-2 lg:py-3 border-2 border-slate-200 rounded-xl focus:border-green-500 focus:ring-4 focus:ring-green-100 focus:outline-none transition-all text-sm lg:text-base bg-white"
                  >
                ...
                >
                  <div className="bg-white rounded-2xl shadow-xl p-8 lg:p-12 max-w-md mx-auto">
                    <div className="w-20 h-20 lg:w-24 lg:h-24 bg-slate-100 rounded-full flex items-center justify-center mx-auto mb-6">
                      <FaBriefcase className="w-10 h-10 lg:w-12 lg:h-12 text-slate-400" />
                    </div>
                    <h3 className="text-xl lg:text-2xl font-bold text-slate-800 mb-4">
                      Aucun questionnaire disponible
                    </h3>
                    <p className="text-slate-600 text-sm lg:text-base">
                      Il n'y a actuellement aucun questionnaire assigné à votre compte professionnel. 
                            ...
                            <div className="p-6 flex-1 flex flex-col">
                              ...
                              <div className="grid grid-cols-2 gap-4 mb-6">
                                ...
                                <div className="text-center p-3 bg-green-50 rounded-xl">
                                  ...
                                  <div className="text-xs text-green-600">Question{stats.totalQuestions > 1 ? 's' : ''}</div>
                                </div>
                              </div>
                              ...
                              <div className="mt-auto">
                                <button
                                  onClick={() => navigate(`/professionnel/questionnaire/${questionnaire.templateCode}`)}
                                  className="w-full bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 text-white font-semibold py-3 px-6 rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl group-hover:scale-105 flex items-center justify-center space-x-2"
                                >
